...
export const LESSON_TOPICS: Record<TargetLanguage, LessonTopic[]> = {
  ...
  English: [
    {
      id: "en-small-talk",
      title: "Everyday Small Talk & Social Connections",
      description: "Break the ice naturally with colleagues, neighbors, and new friends.",
      category: "conversation",
      starterPrompt: "Hi Maestro! How can I make natural small talk at a networking party or with a new neighbor?",
      targetVocab: ["Catch up", "Pleasure to meet you", "How have you been?", "By the way"],
      practiceSentences: [
        "It's great to finally meet you in person; how is your week going?",
        "Have you had a chance to explore the neighborhood yet?",
    ...
    {
      id: "en-travel",
      title: "Airport Transit & Hotel Hospitality",
      description: "Confidently navigate flight gates, baggage claims, and hotel check-in requests.",
      category: "vocabulary",
      starterPrompt: "Hello! I am arriving at an international airport. Can you guide me through check-in and asking for directions?",
      targetVocab: ["Boarding pass", "Baggage claim", "Complimentary", "Itinerary"],
      practiceSentences: [
        "Excuse me, could you point me toward the departure gate for flight 412?",
        "I have a reservation under the name Jordan for two nights.",
        "Could you please arrange a wake-up call for 7:00 AM tomorrow?",
      ],
    },
    {
      id: "en-grammar-tenses",
      title: "Present Perfect vs. Past Simple in Action",
      description: "Speak about life experiences, durations, and recent events with zero hesitation.",
      category: "grammar",
      starterPrompt: "Can you help me practice when to use 'I have done' versus 'I did' in real conversation?",
      targetVocab: ["For and since", "Life experience", "Past participle", "Recent result"],
      practiceSentences: [
        "I have lived here for five years, but I moved from Boston originally.",
        "Have you ever tried authentic Mediterranean cuisine before?",
        "She has already finished the quarterly report ahead of the deadline.",
      ],
    },
    {
      id: "en-pronunciation-th",
      title: "Mastering the Voiced and Voiceless 'TH' Sounds",
      description: "Perfect your tongue placement for words like 'think', 'thought', 'this', and 'breathe'.",
      category: "pronunciation",
      starterPrompt: "I often struggle with the English 'TH' sound. How should my tongue and breath be positioned?",
      targetVocab: ["Voiceless TH", "Voiced TH", "Dental fricative", "Tongue tip"],
      practiceSentences: [
        "I thought that the third Thursday was Thanksgiving.",
        "They breathed together through the brisk morning weather.",
        "Thank you for thinking through that thoughtful proposal.",
      ],
    },
  ],
  Hindi: [
