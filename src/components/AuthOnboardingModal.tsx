          ...
          {step === 1 && (
            <div className="space-y-5">
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold text-sm flex items-center justify-center gap-2 border border-slate-700 transition-all cursor-pointer"
              >
              ...
              <div className="p-3.5 rounded-xl bg-slate-950/50 border border-slate-800/80 text-[11px] text-slate-400 flex items-start gap-2.5">
                ...
                <p>
                  Signing up customizes your 3D tutor's vocal pace, phonetics scoring, and smartboard lessons to match your individual language goals. Guest mode works fully but progress won't sync to the cloud.
                </p>
              </div>
            </div>
          )}
